...
# coxphROTS
`coxphROTS` <- function(formula, data, metadata, B=100, K=NULL, seed=NULL, a1=NULL, a2=NULL, terms=NULL, BPPARAM=bpparam()) {
  ...
  # Optimize parameters
  ROTS.output <- optimizeModel(data=data, model.original=coxph.original, model.boot=coxph.boot, model.null=coxph.null, B=B, K=K, seed=seed, a1=a1, a2=a2, terms=terms, BPPARAM=BPPARAM)
